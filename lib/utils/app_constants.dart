...
class AppSizes {
  ...
  static double safeAreaPadding = MediaQueryData.fromView(WidgetsBinding.instance.platformDispatcher.views.single).padding.top;
...
class AppColors {
  ...
  static const Color lightWhiteColor = Color(0xFFE5E5E5);
  static const Color hintMessageColor = Color(0xFF858585);
